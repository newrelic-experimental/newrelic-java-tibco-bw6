...
public abstract class WorkItemAbstract {
	...
	protected abstract PmWorkUnit getTarget(PmContext context);
	protected transient Work m_work = Weaver.callOriginal();
	  ...
	  public Object execute(PmContext paramPmContext) {
		  ...
		  if(name != null && !name.isEmpty()) {
			  ...
			  NewRelic.getAgent().getTransaction().setTransactionName(TransactionNamePriority.FRAMEWORK_HIGH,false,"WorkUnit",new String[] {"Custom","WorkUnit",name});
		  }
