...
@Weave
public abstract class ServiceINOUTMessageReceiver {

	@Trace
	public void invokeBusinessLogic(MessageContext paramMessageContext) {
		...
		if(localServiceRequestHandler != null) {
			...
			NewRelic.getAgent().getTracedMethod().setMetricName(new String[]{"Custom","ServiceINOUTMessageReceiver","invokeBusinessLogic",endpoint});
		}
		Weaver.callOriginal();
	}
}
